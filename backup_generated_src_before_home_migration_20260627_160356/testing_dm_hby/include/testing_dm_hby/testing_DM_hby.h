...
struct B_testing_DM_hby_T {
  ...
  SL_Bus_custom_msgs_ReadDmMotor In1_ml;// '<S16>/In1'
...
struct DW_testing_DM_hby_T {
  ...
  ros_slros2_internal_block_Sub_T obj_k;// '<S9>/SourceBlock'
  ros_slros2_internal_block_Sub_T obj_h;// '<S8>/SourceBlock'
};
...
struct P_testing_DM_hby_T_ {
  ...
  SL_Bus_custom_msgs_ReadDmMotor Constant_Value_l0;// Computed Parameter: Constant_Value_l0
...
//  '<S8>'   : 'testing_DM_hby/Subscribe_LA'
//  '<S9>'   : 'testing_DM_hby/Subscribe_LB'
...
//  '<S16>'  : 'testing_DM_hby/Subscribe_LA/Enabled Subsystem'
//  '<S17>'  : 'testing_DM_hby/Subscribe_LB/Enabled Subsystem'
