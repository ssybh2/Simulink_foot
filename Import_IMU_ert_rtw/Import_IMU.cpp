...
{
  real32_T leg_angle_b;
  real32_T leg_length_f;
  real32_T xB_c;
  real32_T yB_o;
  boolean_T valid_b;

  // MATLABSystem: '<S8>/SourceBlock'
  valid_b = Sub_Import_IMU_1.getLatestMessage(&Import_IMU_B.b_varargout_2);
  ...
  if (valid_b) {
    ...
    Import_IMU_B.In1_m = Import_IMU_B.b_varargout_2;
  }
  ...
  valid_b = Sub_Import_IMU_2.getLatestMessage(&Import_IMU_B.b_varargout_2);
  ...
  if (valid_b) {
    ...
    Import_IMU_B.In1_j = Import_IMU_B.b_varargout_2;
  }
  ...
  Import__Motor_Position_To_Joint(Import_IMU_B.In1_j.position,
    ...
    Import_IMU_P.CAL.ratio_LB, &Import_IMU_B.q_joint_e);
  ...
  Import_IMU_FiveBar_FK_Left(Import_IMU_B.q_joint_m, Import_IMU_B.q_joint_e,
    Import_IMU_P.L1, Import_IMU_P.L2, Import_IMU_P.L3, Import_IMU_P.L4,
    Import_IMU_P.L5, &xB_c, &yB_o, &leg_length_f, &leg_angle_b, &valid_b);

  // MATLABSystem: '<S10>/SourceBlock'
  valid_b = Sub_Import_IMU_3.getLatestMessage(&Import_IMU_B.b_varargout_2);
  ...
  if (valid_b) {
    ...
    Import_IMU_B.In1_a = Import_IMU_B.b_varargout_2;
  }
  ...
  Import__Motor_Position_To_Joint(Import_IMU_B.In1_a.position,
    ...
    Import_IMU_P.CAL.ratio_RA, &Import_IMU_B.q_joint_m);

  // MATLABSystem: '<S11>/SourceBlock'
  valid_b = Sub_Import_IMU_4.getLatestMessage(&Import_IMU_B.b_varargout_2);
  ...
  Import__Motor_Position_To_Joint(Import_IMU_B.In1.position,
    Import_IMU_P.CAL.qm0_RB, Import_IMU_P.CAL.qj0_RB, Import_IMU_P.CAL.sign_RB,
    Import_IMU_P.CAL.ratio_RB, &Import_IMU_B.q_joint_e);
...
void Import_IMU::initialize()
{
  ...
  Import_IMU_B.In1_m = Import_IMU_P.Out1_Y0;
  ...
  Import_IMU_B.In1_a = Import_IMU_P.Out1_Y0_f;
  ...
  Import_IMU_B.In1 = Import_IMU_P.Out1_Y0_h;

  // End of SystemInitialize for SubSystem: '<S11>/Enabled Subsystem'

  // Start for MATLABSystem: '<S8>/SourceBlock'
  Import_IMU_SystemCore_setup(&Import_IMU_DW.obj_n);

  // Start for MATLABSystem: '<S9>/SourceBlock'
  Import_IMU_SystemCore_setup_i(&Import_IMU_DW.obj_g);

  // Start for MATLABSystem: '<S10>/SourceBlock'
  Import_IMU_SystemCore_setup_iu(&Import_IMU_DW.obj_d);

  // Start for MATLABSystem: '<S11>/SourceBlock'
  Import_IMU_SystemCore_setup_iuf(&Import_IMU_DW.obj);
}
